...
class ControllerQuestion
{
    ...
    public static function reinstate(): void {
        ...
        MessageFlash::ajouter("success", "La question a bien été restaurée !");
        self::home();
    }
    ...
    public static function tryToCreate(): void {
        if ($_POST['dateStartAnswer'] < $_POST['dateEndAnswer'] && $_POST['dateEndAnswer'] < $_POST['dateStartVote'] && $_POST['dateStartVote'] < $_POST['dateEndVote'] && $_POST['allVoters'] != '') {
            ...
            MessageFlash::ajouter("danger", "La question n'a pas été créée car il n'y a aucun votant");
            self::create();
        } else {
    ...
    public static function delete(): void {
        ...
        if (!$isAuth) {
            ...
            MessageFlash::ajouter("success", "La question a bien été supprimmée !");
